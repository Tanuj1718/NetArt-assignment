    ...
    return(
        ...
        <div className=" h-auto w=[100vw] m-2 mt-10 font-semibold text-[15px] flex flex-col">
            ...
            <div className="flex justify-center items-center w-[100%] mt-2">
                <img className="w-[80%]" src="../public/assets/3.png" alt="" />
            </div>
            ...
            <h3 className="text-center font-bold p-2">C.R.I. FLUID SYSTEMS PRODUCTS CATER TO DIVERSE SEGMENTS</h3>
            <p className="p-5 text-pretty">CHEMICALS & PROCESS | POWER | WATER & WASTE WATER | OILS & GAS | PHARMA | SUGARS & DISTILLERIES | PAPER & PULP | MARINE & DEFENCE | METAL & MINING | FOOD & BEVERAGE | PETROCHEMICAL & REFINERIES | SOLAR | BUILDING | HVAC | FIRE | FIGHTING | AGRICULTURE & RESIDENTIAL</p>
            </div>
        </div>
        </>
    )
